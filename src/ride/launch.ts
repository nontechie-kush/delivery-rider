...
export async function launchRide(
  ...
  const { promise } = runRide(
    stage,
    {
      ...
      hornYieldChance: cfg.hornYieldChance,
      strikeCooldown: cfg.strikeCooldown,
      strikeReach: cfg.strikeReach,
      strikeShove: cfg.strikeShove,
      counterChance: cfg.counterChance,
